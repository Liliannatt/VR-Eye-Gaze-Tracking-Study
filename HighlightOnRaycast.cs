    ...
    void Update()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            else
            {
                ...
                Highlight2350 highlightComponent = mainParent.GetComponent<Highlight2350>();
                ...
                if (highlightComponent != null)
                {
                    ...
                    // if (lastHitObject != null && lastHitObject != hit.collider.gameObject)
                    {
                        ...
                        Highlight2350 lastHighlightComponent = lastMainParent.GetComponent<Highlight2350>();
                        ...
                        // {
                            ...
                            if (lastHighlightComponent != null)
                            {
                                ...
                                lastHighlightComponent.ToggleHighlight2350(false);
                            }
                        // }
                    }
                    // Change the color of the hit object
                    // renderer.material.color = Color.black;
                    highlightComponent.ToggleHighlight2350(true);
        ...
        if (Input.GetKeyDown(KeyCode.Escape))
        {
            ...
            string dataEntry = $"{exitTime}";
            csvData.Add(dataEntry);
            Debug.Log("Exit Recording: " + exitTime);
